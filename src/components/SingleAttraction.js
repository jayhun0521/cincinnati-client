          ...
          <div className="singleContainer">
            <div className="singleHeaderContainer">
              <div className="singleHeaderInfo">
                <div className="singleName">{this.state.name}</div>
              ...
              <div className="singleDescriptionContainer">
                ...
                <div className="singleBooleans">
                  <div id="singleIndoors">
                    <span>Indoors?</span> <br /> {this.state.indoors}
                  </div>
                  <div id="singleFamily">
                    <span>Family Friendly?</span> <br />{" "}
